...
forward_vars=(
    ...
    HIDDEN_STATES_PATH VERIFIER_HIDDEN_STATES_PATH MTP_DRAFT_PATH OUTPUT_PATH LOG_ROOT VERIFIER_METADATA_PATH
    ...
    NODE_RANK MASTER_ADDR MASTER_PORT LOCAL_IP NIC_NAME RUN_ID NUM_SPECULATIVE_STEPS TOTAL_SEQ_LEN
    EPOCHS LR WEIGHT_DECAY STEP_WEIGHT_BETA CHECKPOINT_STEPS TRAIN_DATA_RATIO
    OFFLINE_COLLECTION_CONCURRENCY OFFLINE_COLLECTION_WRITE_CONCURRENCY
    OFFLINE_COLLECTION_SCHEDULE OFFLINE_COLLECTION_CLAIM_TIMEOUT OFFLINE_COLLECTION_POLL_INTERVAL
    OFFLINE_COLLECTION_MAX_SAMPLES
    OFFLINE_VALIDATION_SAMPLES OFFLINE_COLLECTION_WORLD_SIZE OFFLINE_COLLECTION_RANK
    FSDP_SKIP_INITIAL_BROADCAST FSDP_WRAP_POLICY FSDP_MIN_NUMEL
    FSDP_EXPERTS_PER_UNIT MTP_LOGITS_CHUNK_SIZE MTP_ACTIVATION_CHECKPOINTING MTP_TRAINING_STRATEGY
    STARTUP_HEARTBEAT_SECONDS
    NUM_WORKERS PREFETCH_FACTOR REQUEST_TIMEOUT MAX_RETRIES MAX_STEPS RUN_NAME TRAINER_DATA_MODE MEMORY_LOG_FREQ SMOKE_SAMPLES SMOKE_RUN_ID
